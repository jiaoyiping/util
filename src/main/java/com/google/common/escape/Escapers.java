...
/**
 * Static utility methods pertaining to {@link com.google.common.escape.Escaper} instances.
 *
 * @author Sven Mawson
...
public final class Escapers {
  ...
  /**
   * Returns an {@link com.google.common.escape.Escaper} that does no escaping, passing all character
   ...
   * {@link com.google.common.escape.ArrayBasedCharEscaper} or {@link com.google.common.escape.ArrayBasedUnicodeEscaper} to
  ...
  /**
   * Returns a {@link com.google.common.escape.UnicodeEscaper} equivalent to the given escaper instance.
   * If the escaper is already a UnicodeEscaper then it is simply returned,
   * otherwise it is wrapped in a UnicodeEscaper.
   *
   * <p>When a {@link com.google.common.escape.CharEscaper} escaper is wrapped by this method it acquires
   ...
   * production users of {@link com.google.common.escape.CharEscaper} should limit themselves to its
   * public interface.
   *
   ...
   * escaper, or {@code null} if no replacement should be made. This method is
   * intended for use in tests through the {@code EscaperAsserts} class;
   * production users of {@link com.google.common.escape.UnicodeEscaper} should limit themselves to its
   * public interface.
   *
