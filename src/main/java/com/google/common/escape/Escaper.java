 ...
 *
 * <p>The two primary implementations of this interface are {@link com.google.common.escape.CharEscaper} and {@link
 * com.google.common.escape.UnicodeEscaper}. They are heavily optimized for performance and greatly simplify the task of
 ...
 * SourceCodeEscapers}. To create your own escapers, use {@link com.google.common.escape.CharEscaperBuilder}, or extend
...
public abstract class Escaper {
   ...
   *
   * <ul>
   * <li>{@link com.google.common.escape.UnicodeEscaper} handles <a href="http://en.wikipedia.org/wiki/UTF-16">UTF-16</a>
   *     correctly, including surrogate character pairs. If the input is badly formed the escaper
   *     should throw {@link IllegalArgumentException}.
   * <li>{@link com.google.common.escape.CharEscaper} handles Java characters independently and does not verify the input for
  ...
  /**
   * Returns a {@link com.google.common.base.Function} that invokes {@link #escape(String)} on this escaper.
   */
