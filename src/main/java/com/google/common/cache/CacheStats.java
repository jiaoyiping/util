...
/**
 * Statistics about the performance of a {@link com.google.common.cache.Cache}. Instances of this class are immutable.
 *
 ...
 * <li>No stats are modified on a query to {@link com.google.common.cache.Cache#getIfPresent}.
 * <li>No stats are modified by operations invoked on the {@linkplain com.google.common.cache.Cache#asMap asMap} view of
 *     the cache.
 * </ul>
 * 
 * <p>A lookup is specifically defined as an invocation of one of the methods 
 * {@link com.google.common.cache.LoadingCache#get(Object)}, {@link com.google.common.cache.LoadingCache#getUnchecked(Object)},
 * {@link com.google.common.cache.Cache#get(Object, java.util.concurrent.Callable)}, or {@link com.google.common.cache.LoadingCache#getAll(Iterable)}.
 *
 * @author Charles Fry
 * @since 10.0
 */
