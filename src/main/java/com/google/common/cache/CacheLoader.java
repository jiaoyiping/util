...
/**
 * Computes or retrieves values, based on a key, for use in populating a {@link com.google.common.cache.LoadingCache}.
 *
...
public abstract class CacheLoader<K, V> {
   ...
   * {@link com.google.common.cache.CacheBuilder#refreshAfterWrite}, or through a call to {@link com.google.common.cache.LoadingCache#refresh}.
   *
   ...
   * {@link com.google.common.cache.CacheBuilder#refreshAfterWrite}.
   *
   ...
   * {@link com.google.common.cache.LoadingCache#getAll}.
   *
   ...
   * many individual lookups. Note that {@link com.google.common.cache.LoadingCache#getAll} will defer to individual calls
   * to {@link com.google.common.cache.LoadingCache#get} if this method is not overriden.
   *
   ...
   * @return a cache loader that loads values by calling {@link com.google.common.base.Supplier#get}, irrespective of the
   *     key
   */
  @Beta
   ...
   * {@link com.google.common.cache.CacheLoader#reload} using {@code executor}.
   *
  ...
  /**
   * Thrown to indicate that an invalid response was returned from a call to {@link com.google.common.cache.CacheLoader}.
   *
   * @since 11.0
   */
