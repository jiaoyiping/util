...
/**
 * <p>A builder of {@link com.google.common.cache.LoadingCache} and {@link com.google.common.cache.Cache} instances having any combination of the
 * following features:
 *
 * <ul>
 ...
 * {@link java.util.concurrent.ConcurrentHashMap}. It implements all optional operations of the {@link com.google.common.cache.LoadingCache} and
 * {@link com.google.common.cache.Cache} interfaces. The {@code asMap} view (and its collection views) have <i>weakly
 ...
 * cache modification, on occasional cache accesses, or on calls to {@link com.google.common.cache.Cache#cleanUp}. Expired
 * entries may be counted by {@link com.google.common.cache.Cache#size}, but will never be visible to read or write
 * operations.
 *
 ...
 * {@link com.google.common.cache.Cache#cleanUp}; such entries may be counted in {@link com.google.common.cache.Cache#size}, but will never be
 * visible to read or write operations.
 *
 * <p>Certain cache configurations will result in the accrual of periodic maintenance tasks which
 * will be performed during write operations, or during occasional read operations in the absence of
 * writes. The {@link com.google.common.cache.Cache#cleanUp} method of the returned cache will also perform maintenance, but
...
public final class CacheBuilder<K, V> {
   ...
   *
   * @param spec a String in the format specified by {@link com.google.common.cache.CacheBuilderSpec}
   * @since 12.0
   */
  @Beta
  @GwtIncompatible("To be supported")
   ...
   *
   * <p>By default, the cache uses {@link com.google.common.base.Equivalence#identity} to determine key equality when
   * {@link #weakKeys} is specified, and {@link com.google.common.base.Equivalence#equals()} otherwise.
   */
  @GwtIncompatible("To be supported")
   ...
   *
   * <p>By default, the cache uses {@link com.google.common.base.Equivalence#identity} to determine value equality when
   * {@link #weakValues} or {@link #softValues} is specified, and {@link com.google.common.base.Equivalence#equals()}
   * otherwise.
   */
  @GwtIncompatible("To be supported")
   ...
   * {@link com.google.common.cache.Weigher} specified with {@link #weigher}, and use of this method requires a
   ...
   *
   * <p>Entries with keys that have been garbage collected may be counted in {@link com.google.common.cache.Cache#size},
   ...
   *
   * <p>Entries with values that have been garbage collected may be counted in {@link com.google.common.cache.Cache#size},
   * but will never be visible to read or write operations; such entries are cleaned up as part of
   * the routine maintenance described in the class javadoc.
   *
   ...
   * {@linkplain com.google.common.cache.RemovalCause reason}. Each cache created by this builder will invoke this listener
   ...
   * the {@code Cache} user, only logged via a {@link java.util.logging.Logger}.
   *
   ...
   *
   * <p>Consider {@link #build(com.google.common.cache.CacheLoader)} instead, if it is feasible to implement a
   * {@code CacheLoader}.
   *
   * <p>This method does not alter the state of this {@code CacheBuilder} instance, so it can be
   * invoked again to create multiple independent caches.
