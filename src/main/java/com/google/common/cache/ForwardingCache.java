...
public abstract class ForwardingCache<K, V> extends ForwardingObject implements Cache<K, V> {
  ...
  /**
   * A simplified version of {@link com.google.common.cache.ForwardingCache} where subclasses can pass in an already
   * constructed {@link com.google.common.cache.Cache} as the delegete.
   *
   * @since 10.0
   */
  @Beta
