 ...
 *
 * <p>When evaluated as a {@link com.google.common.base.Function}, a cache yields the same result as invoking
 * {@link #getUnchecked}.
 *
 * <p>Note that while this class is still annotated as {@link com.google.common.annotations.Beta}, the API is frozen from a
...
public interface LoadingCache<K, V> extends Cache<K, V>, Function<K, V> {
   ...
   *
   * <p>Caches loaded by a {@link com.google.common.cache.CacheLoader} will call {@link com.google.common.cache.CacheLoader#load} to load new values
   ...
   *
   * @throws java.util.concurrent.ExecutionException if a checked exception was thrown while loading the value. ({@code
   ...
   * @throws com.google.common.util.concurrent.UncheckedExecutionException if an unchecked exception was thrown while loading the
   *     value
   * @throws com.google.common.util.concurrent.ExecutionError if an error was thrown while loading the value
   */
   ...
   * {@link #get} instead.
   *
   * @throws com.google.common.util.concurrent.UncheckedExecutionException if an exception was thrown while loading the value. (As
   ...
   *
   * <p>Caches loaded by a {@link com.google.common.cache.CacheLoader} will issue a single request to
   * {@link com.google.common.cache.CacheLoader#loadAll} for all keys which are not already present in the cache. All
   * entries returned by {@link com.google.common.cache.CacheLoader#loadAll} will be stored in the cache, over-writing
   * any previously cached values. This method will throw an exception if
   * {@link com.google.common.cache.CacheLoader#loadAll} returns {@code null}, returns a map containing null keys or values,
   ...
   * @throws com.google.common.util.concurrent.UncheckedExecutionException if an unchecked exception was thrown while loading the
   *     values
   * @throws com.google.common.util.concurrent.ExecutionError if an error was thrown while loading the values
   * @since 11.0
   */
   ...
   *
   * <p>Caches loaded by a {@link com.google.common.cache.CacheLoader} will call {@link com.google.common.cache.CacheLoader#reload} if the
   * cache currently contains a value for {@code key}, and {@link com.google.common.cache.CacheLoader#load} otherwise.
   * Loading is asynchronous only if {@link com.google.common.cache.CacheLoader#reload} was overridden with an
