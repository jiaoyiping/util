...
public abstract class ForwardingLoadingCache<K, V>
  ...
  /**
   * A simplified version of {@link com.google.common.cache.ForwardingLoadingCache} where subclasses can pass in an already
   * constructed {@link com.google.common.cache.LoadingCache} as the delegete.
   *
   * @since 10.0
   */
  @Beta
