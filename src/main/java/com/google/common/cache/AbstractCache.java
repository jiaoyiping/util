...
public abstract class AbstractCache<K, V> implements Cache<K, V> {
  ...
  /**
   * Accumulates statistics during the operation of a {@link com.google.common.cache.Cache} for presentation by {@link
   * com.google.common.cache.Cache#stats}. This is solely intended for consumption by {@code Cache} implementors.
   *
   * @since 10.0
   */
  @Beta
  public interface StatsCounter {
     ...
     * threads blocking on the load. Multiple concurrent calls to {@link com.google.common.cache.Cache} lookup methods with
  ...
  /**
   * A thread-safe {@link com.google.common.cache.AbstractCache.StatsCounter} implementation for use by {@link com.google.common.cache.Cache} implementors.
   *
   * @since 10.0
   */
  @Beta
