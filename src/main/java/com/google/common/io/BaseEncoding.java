...
public abstract class BaseEncoding {
   ...
   * This is the inverse operation to {@link #encode(byte[])}.
   *
   * @throws com.google.common.io.BaseEncoding.DecodingException if the input is not a valid encoded string according to this
   *         encoding.
   */
   ...
   * {@code Reader}.  The returned stream throws a {@link com.google.common.io.BaseEncoding.DecodingException} upon decoding-specific
   * errors.
   */
