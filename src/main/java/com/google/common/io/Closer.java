...
/**
 * A {@link java.io.Closeable} that collects {@code Closeable} resources and closes them all when it is
...
public final class Closer implements Closeable {
  ...
  /**
   * Creates a new {@link com.google.common.io.Closer}.
   */
   ...
   * @throws java.io.IOException when the given throwable is an IOException
   */
