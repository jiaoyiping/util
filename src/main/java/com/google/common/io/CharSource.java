...
/**
 * A readable source of characters, such as a text file. Unlike a {@link java.io.Reader}, a
 ...
 * source into lines. Like {@link java.io.BufferedReader}, these methods break lines on any of {@code \n},
 ...
 *
 * <p>Any {@link com.google.common.io.ByteSource} containing text encoded with a specific {@linkplain java.nio.charset.Charset character
 * encoding} may be viewed as a {@code CharSource} using {@link com.google.common.io.ByteSource#asCharSource(java.nio.charset.Charset)}.
 *
 * @since 14.0
 * @author Colin Decker
 */
public abstract class CharSource {
  ...
  /**
   * Opens a new {@link java.io.Reader} for reading from this source. This method should return a new,
   * independent reader each time it is called.
   *
   * <p>The caller is responsible for ensuring that the returned reader is closed.
   *
   * @throws java.io.IOException if an I/O error occurs in the process of opening the reader
   */
  public abstract Reader openStream() throws IOException;

  /**
   * Opens a new {@link java.io.BufferedReader} for reading from this source. This method should return a
  ...
  /**
   * Appends the contents of this source to the given {@link Appendable} (such as a {@link java.io.Writer}).
   * Does not close {@code appendable} if it is {@code Closeable}.
   *
   * @throws java.io.IOException if an I/O error occurs in the process of reading from this source or
   ...
   *
   * @throws java.io.IOException if an I/O error occurs in the process of reading from this source
   */
   ...
   *
   * <p>Like {@link java.io.BufferedReader}, this method breaks lines on any of {@code \n}, {@code \r} or
   ...
   * {@link com.google.common.io.LineProcessor processor}. Stops when all lines have been processed or the processor
   ...
   *
   * @throws java.io.IOException if an I/O error occurs in the process of reading from this source or if
  ...
  /**
   * Concatenates multiple {@link com.google.common.io.CharSource} instances into a single source. Streams returned from
  ...
  /**
   * Returns a view of the given character sequence as a {@link com.google.common.io.CharSource}. The behavior of the
  ...
  /**
   * Returns an immutable {@link com.google.common.io.CharSource} that contains no characters.
   *
   * @since 15.0
   */
