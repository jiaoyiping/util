...
/**
 * A destination to which characters can be written, such as a text file. Unlike a {@link java.io.Writer}, a
 ...
 * </ul>
 *
 * <p>Any {@link com.google.common.io.ByteSink} may be viewed as a {@code CharSink} with a specific {@linkplain java.nio.charset.Charset
 * character encoding} using {@link com.google.common.io.ByteSink#asCharSink(java.nio.charset.Charset)}. Characters written to the
...
public abstract class CharSink {
  ...
  /**
   * Opens a new {@link java.io.Writer} for writing to this sink. This method should return a new,
   * independent writer each time it is called.
   *
   * <p>The caller is responsible for ensuring that the returned writer is closed.
   *
   * @throws java.io.IOException if an I/O error occurs in the process of opening the writer
   */
  public abstract Writer openStream() throws IOException;

  /**
   * Opens a new buffered {@link java.io.Writer} for writing to this sink. The returned stream is not
   * required to be a {@link java.io.BufferedWriter} in order to allow implementations to simply delegate
   ...
   *
   * @throws java.io.IOException if an I/O error occurs in the process of opening the writer
   * @since 15.0 (in 14.0 with return type {@link java.io.BufferedWriter})
   */
   ...
   *
   * @throws java.io.IOException if an I/O error in the process of writing to this sink
   */
   ...
   *
   * @throws java.io.IOException if an I/O error occurs in the process of writing to this sink
   */
  ...
  /**
   * Writes all the text from the given {@link Readable} (such as a {@link java.io.Reader}) to this sink.
   * Does not close {@code readable} if it is {@code Closeable}.
   *
   * @throws java.io.IOException if an I/O error occurs in the process of reading from {@code readable} or
