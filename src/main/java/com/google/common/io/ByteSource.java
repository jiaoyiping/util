...
/**
 * A readable source of bytes, such as a file. Unlike an {@link java.io.InputStream}, a
...
public abstract class ByteSource {
  ...
  /**
   * Returns a {@link com.google.common.io.CharSource} view of this byte source that decodes bytes read from this source
   * as characters using the given {@link java.nio.charset.Charset}.
   */
  ...
  /**
   * Opens a new {@link java.io.InputStream} for reading from this source. This method should return a new,
   * independent stream each time it is called.
   *
   * <p>The caller is responsible for ensuring that the returned stream is closed.
   *
   * @throws java.io.IOException if an I/O error occurs in the process of opening the stream
   */
  public abstract InputStream openStream() throws IOException;

  /**
   * Opens a new buffered {@link java.io.InputStream} for reading from this source. The returned stream is
   * not required to be a {@link java.io.BufferedInputStream} in order to allow implementations to simply
   ...
   *
   * @throws java.io.IOException if an I/O error occurs in the process of opening the stream
   * @since 15.0 (in 14.0 with return type {@link java.io.BufferedInputStream})
   */
   ...
   * operation that will open a stream, read (or {@link java.io.InputStream#skip(long) skip}, if possible)
   ...
   *
   * @throws java.io.IOException if an I/O error occurs in the process of reading the size of this source
   */
  ...
  /**
   * Concatenates multiple {@link com.google.common.io.ByteSource} instances into a single source. Streams returned from
  ...
  /**
   * Returns a view of the given byte array as a {@link com.google.common.io.ByteSource}. To view only a specific range
  ...
  /**
   * Returns an immutable {@link com.google.common.io.ByteSource} that contains no bytes.
   *
   * @since 15.0
   */
