...
public final class FileBackedOutputStream extends OutputStream {
   ...
   * not reset the data when the {@link com.google.common.io.ByteSource} returned by
   ...
   * optionally resets the data when the {@link com.google.common.io.ByteSource} returned
   * by {@link #asByteSource} is finalized.
   *
   * @param fileThreshold the number of bytes before the stream should
   *     switch to buffering to a file
   * @param resetOnFinalize if true, the {@link #reset} method will
   *     be called when the {@link com.google.common.io.ByteSource} returned by {@link
  ...
  /**
   * Returns a readable {@link com.google.common.io.ByteSource} view of the data that has been
