...
public final class Resources {
  ...
  /**
   * Returns a {@link com.google.common.io.ByteSource} that reads from the given URL.
   *
   * @since 14.0
   */
  ...
  /**
   * A byte source that reads from a URL using {@link java.net.URL#openStream()}.
   */
  ...
  /**
   * Returns a {@link com.google.common.io.CharSource} that reads from the given URL using the given
   * character set.
   *
   * @since 14.0
   */
