...
public final class MoreExecutors {
   ...
   * @deprecated Use {@link #directExecutor()} if you only require an {@link java.util.concurrent.Executor} and
   *     {@link #newDirectExecutorService()} if you need a {@link com.google.common.util.concurrent.ListeningExecutorService}.
   */
  ...
  /**
   * Returns an {@link java.util.concurrent.Executor} that runs each task in the thread that invokes
   * {@link java.util.concurrent.Executor#execute execute}, as in {@link java.util.concurrent.ThreadPoolExecutor.CallerRunsPolicy}.
   *
   ...
   * {@link java.util.concurrent.ExecutorService} subinterface necessitates significant performance overhead.
   *
   * @since 18.0
   */
   ...
   * invokeAll} methods submit {@link com.google.common.util.concurrent.ListenableFutureTask} instances to the
  ...
  /**
   * An implementation of {@link java.util.concurrent.ExecutorService#invokeAny} for {@link com.google.common.util.concurrent.ListeningExecutorService}
   * implementations.
   ...
   * Otherwise, returns {@link java.util.concurrent.Executors#defaultThreadFactory()}.
   *
   * @since 14.0
   */
  @Beta
  ...
  /**
   * Creates an {@link java.util.concurrent.Executor} that renames the {@link Thread threads} that its tasks run in.
   *
  ...
  /**
   * Creates an {@link java.util.concurrent.ExecutorService} that renames the {@link Thread threads} that its tasks run
   * in.
   *
   * <p>The names are retrieved from the {@code nameSupplier} on the thread that is being renamed
   * right before each task is run.  The renaming is best effort, if a {@link SecurityManager}
  ...
  /**
   * Creates a {@link java.util.concurrent.ScheduledExecutorService} that renames the {@link Thread threads} that its
   * tasks run in.
   *
   * <p>The names are retrieved from the {@code nameSupplier} on the thread that is being renamed
   * right before each task is run.  The renaming is best effort, if a {@link SecurityManager}
   ...
   * <ol>
   *  <li>calls {@link java.util.concurrent.ExecutorService#shutdown()}, disabling acceptance of new submitted tasks.
   *  <li>waits for half of the specified timeout.
   *  <li>if the timeout expires, it calls {@link java.util.concurrent.ExecutorService#shutdownNow()}, cancelling
   ...
   * interrupted, the method calls {@link java.util.concurrent.ExecutorService#shutdownNow()}, cancelling
   * pending tasks and interrupting running tasks.
   *
