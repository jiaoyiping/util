...
public abstract class AbstractFuture<V> implements ListenableFuture<V> {
   ...
   * {@inheritDoc}
   *
   * <p>The default {@link com.google.common.util.concurrent.AbstractFuture} implementation throws {@code
   ...
   * {@link com.google.common.util.concurrent.AbstractFuture.Sync#COMPLETED} and invoke the listeners if the
