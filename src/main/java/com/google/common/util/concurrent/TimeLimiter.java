...
public interface TimeLimiter {
   ...
   * call to the target, and will throw an {@link com.google.common.util.concurrent.UncheckedTimeoutException} to
   * the caller.
   * <p>
   ...
   * target, and throw an {@link com.google.common.util.concurrent.UncheckedTimeoutException} to the caller.
   * <p>
   ...
   * @throws com.google.common.util.concurrent.UncheckedTimeoutException if the time limit is reached
   * @throws Exception
   */
