 ...
 * {@linkplain #wrapTask(java.util.concurrent.Callable) wrap} tasks before they are submitted
...
abstract class WrappingExecutorService implements ExecutorService {
   ...
   * default implementation delegates to {@link #wrapTask(java.util.concurrent.Callable)}.
   */
