 ...
 *
 * <p>Many of these methods use the {@link com.google.common.util.concurrent.ListenableFuture} API; consult the
...
public final class Futures {
  ...
  /**
   * Creates a {@link com.google.common.util.concurrent.CheckedFuture} out of a normal {@link com.google.common.util.concurrent.ListenableFuture}
   * and a {@link com.google.common.base.Function} that maps from {@link Exception} instances into the
   ...
   * provided by the {@code fallback}. {@link com.google.common.util.concurrent.FutureFallback#create} is not
   ...
   * irrelevant), consider {@linkplain #withFallback(com.google.common.util.concurrent.ListenableFuture,
   * com.google.common.util.concurrent.FutureFallback, java.util.concurrent.Executor) supplying an executor}. If you do not supply an
   * executor, {@code withFallback} will use a
   * {@linkplain com.google.common.util.concurrent.MoreExecutors#directExecutor direct executor}, which carries
   ...
   * @param fallback the {@link com.google.common.util.concurrent.FutureFallback} implementation to be called if
   *     {@code input} fails
   * @since 14.0
   */
   ...
   * consider {@linkplain #withFallback(com.google.common.util.concurrent.ListenableFuture, com.google.common.util.concurrent.FutureFallback)
   ...
   * <p>Note: If the derived {@code Future} is slow or heavyweight to create
   * (whether the {@code Future} itself is slow or heavyweight to complete is
   * irrelevant), consider {@linkplain #transform(com.google.common.util.concurrent.ListenableFuture,
   * com.google.common.util.concurrent.AsyncFunction, java.util.concurrent.Executor) supplying an executor}. If you do not supply an
   ...
   * (though the {@code Future} it returns need not meet these criteria),
   * consider {@linkplain #transform(com.google.common.util.concurrent.ListenableFuture, com.google.common.util.concurrent.AsyncFunction) omitting
   ...
   * #transform(com.google.common.util.concurrent.ListenableFuture, com.google.common.base.Function, java.util.concurrent.Executor) supplying an executor}.
   ...
   * #transform(com.google.common.util.concurrent.ListenableFuture, com.google.common.base.Function) omitting the executor} or
  ...
  /**
   * Like {@link #transform(com.google.common.util.concurrent.ListenableFuture, com.google.common.base.Function)} except that the
   ...
   * #transform(com.google.common.util.concurrent.ListenableFuture, com.google.common.util.concurrent.AsyncFunction)}, in that the returned {@code
   ...
   * #addCallback(com.google.common.util.concurrent.ListenableFuture, com.google.common.util.concurrent.FutureCallback, java.util.concurrent.Executor) supplying an
   * executor}. If you do not supply an executor, {@code addCallback} will use
   * a {@linkplain com.google.common.util.concurrent.MoreExecutors#directExecutor direct executor}, which carries
   ...
   * {@code Future}, see {@link com.google.common.util.concurrent.ListenableFuture#addListener addListener}.
   *
   ...
   * #addCallback(com.google.common.util.concurrent.ListenableFuture, com.google.common.util.concurrent.FutureCallback) omitting the executor} or
   * explicitly specifying {@code directExecutor}. However, be aware of the
   * caveats documented in the link above.
   *
   * <p>For a more general interface to attach a completion listener to a
   ...
   *     com.google.common.util.concurrent.UncheckedExecutionException} if the cause is a {@code
   *     RuntimeException}, or an {@link com.google.common.util.concurrent.ExecutionError} if the cause is an
   *     {@code Error}.
   ...
   * @throws com.google.common.util.concurrent.UncheckedExecutionException if {@code get} throws an {@code
   *         ExecutionException} with a {@code RuntimeException} as its cause
   * @throws com.google.common.util.concurrent.ExecutionError if {@code get} throws an {@code ExecutionException}
   ...
   * <ul>
   * <li>Any {@link java.util.concurrent.ExecutionException} has its <i>cause</i> wrapped in an
   *     {@link com.google.common.util.concurrent.UncheckedExecutionException} (if the cause is an {@code
   *     Exception}) or {@link com.google.common.util.concurrent.ExecutionError} (if the cause is an {@code
   *     Error}).
   ...
   * {@link com.google.common.util.concurrent.Uninterruptibles#getUninterruptibly(java.util.concurrent.Future)}.
   *
   * @throws com.google.common.util.concurrent.UncheckedExecutionException if {@code get} throws an {@code
