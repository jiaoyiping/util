 ...
 *
 * <p>Most subclasses can simply extend {@link com.google.common.util.concurrent.ForwardingCheckedFuture.SimpleForwardingCheckedFuture}.
 * 
...
public abstract class ForwardingCheckedFuture<V, X extends Exception> 
  ...
  /**
   * A simplified version of {@link com.google.common.util.concurrent.ForwardingCheckedFuture} where subclasses
   * can pass in an already constructed {@link com.google.common.util.concurrent.CheckedFuture} as the delegate.
   * 
   * @since 9.0
   */
  @Beta
