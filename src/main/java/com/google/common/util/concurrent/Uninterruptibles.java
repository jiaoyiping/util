...
public final class Uninterruptibles {
   ...
   * {@link com.google.common.util.concurrent.Futures#getUnchecked}.
   *
   * <p>If instead, you wish to treat {@link InterruptedException} uniformly
   * with other exceptions, see {@link com.google.common.util.concurrent.Futures#get(java.util.concurrent.Future, Class) Futures.get}
   * or {@link com.google.common.util.concurrent.Futures#makeChecked}.
   *
  ...
  /**
   * Invokes {@code semaphore.}{@link java.util.concurrent.Semaphore#tryAcquire(int, long, java.util.concurrent.TimeUnit)
