 ...
 * <ul>
 *   <li>{@linkplain com.google.common.util.concurrent.Service.State#NEW NEW} -&gt;
 *   <li>{@linkplain com.google.common.util.concurrent.Service.State#STARTING STARTING} -&gt;
 *   <li>{@linkplain com.google.common.util.concurrent.Service.State#RUNNING RUNNING} -&gt;
 *   <li>{@linkplain com.google.common.util.concurrent.Service.State#STOPPING STOPPING} -&gt;
 *   <li>{@linkplain com.google.common.util.concurrent.Service.State#TERMINATED TERMINATED}
 * </ul>
 *
 * <p>There are deviations from this if there are failures or if {@link com.google.common.util.concurrent.Service#stopAsync} is called
 * before the {@link com.google.common.util.concurrent.Service} reaches the {@linkplain com.google.common.util.concurrent.Service.State#RUNNING RUNNING} state. The set of legal
 * transitions form a <a href="http://en.wikipedia.org/wiki/Directed_acyclic_graph">DAG</a>, 
 * therefore every method of the listener will be called at most once. N.B. The {@link com.google.common.util.concurrent.Service.State#FAILED}
 * and {@link com.google.common.util.concurrent.Service.State#TERMINATED} states are terminal states, once a service enters either of these
...
public interface Service {
  /**
   * If the service state is {@link com.google.common.util.concurrent.Service.State#NEW}, this initiates service startup and returns
   * immediately. A stopped service may not be restarted.
   * 
   * @return this
   * @throws IllegalStateException if the service is not {@link com.google.common.util.concurrent.Service.State#NEW}
   *
   * @since 15.0
   */
  Service startAsync();
  ...
  /**
   * Returns {@code true} if this service is {@linkplain com.google.common.util.concurrent.Service.State#RUNNING running}.
   */
  boolean isRunning();
  ...
  /**
   * If the service is {@linkplain com.google.common.util.concurrent.Service.State#STARTING starting} or {@linkplain com.google.common.util.concurrent.Service.State#RUNNING running},
   * this initiates service shutdown and returns immediately. If the service is
   * {@linkplain com.google.common.util.concurrent.Service.State#NEW new}, it is {@linkplain com.google.common.util.concurrent.Service.State#TERMINATED terminated} without having been
  ...
  /**
   * Waits for the {@link com.google.common.util.concurrent.Service} to reach the {@linkplain com.google.common.util.concurrent.Service.State#RUNNING running state}.
   *
   * @throws IllegalStateException if the service reaches a state from which it is not possible to
   *     enter the {@link com.google.common.util.concurrent.Service.State#RUNNING} state. e.g. if the {@code state} is
  ...
  /**
   * Waits for the {@link com.google.common.util.concurrent.Service} to reach the {@linkplain com.google.common.util.concurrent.Service.State#RUNNING running state} for no
   * more than the given time.
   *
   * @param timeout the maximum time to wait
   * @param unit the time unit of the timeout argument
   * @throws java.util.concurrent.TimeoutException if the service has not reached the given state within the deadline
   * @throws IllegalStateException if the service reaches a state from which it is not possible to
   *     enter the {@link com.google.common.util.concurrent.Service.State#RUNNING RUNNING} state. e.g. if the {@code state} is
   *     {@code State#TERMINATED} when this method is called then this will throw an 
   *     IllegalStateException.
   *
   * @since 15.0
  ...
  /**
   * Waits for the {@link com.google.common.util.concurrent.Service} to reach the {@linkplain com.google.common.util.concurrent.Service.State#TERMINATED terminated state}.
   * 
   * @throws IllegalStateException if the service {@linkplain com.google.common.util.concurrent.Service.State#FAILED fails}.
   * 
   * @since 15.0
   */
  ...
  /**
   * Waits for the {@link com.google.common.util.concurrent.Service} to reach a terminal state (either
   * {@link com.google.common.util.concurrent.Service.State#TERMINATED terminated} or {@link com.google.common.util.concurrent.Service.State#FAILED failed}) for no
   * more than the given time.
   *
   * @param timeout the maximum time to wait
   * @param unit the time unit of the timeout argument
   ...
   * 
   * @throws IllegalStateException if this service's state isn't {@linkplain com.google.common.util.concurrent.Service.State#FAILED FAILED}.
   *
   * @since 14.0
   */
  ...
  /**
   * Registers a {@link com.google.common.util.concurrent.Service.Listener} to be {@linkplain java.util.concurrent.Executor#execute executed} on the given
   ...
   * 
   * <p>The ordering of the {@link com.google.common.util.concurrent.Service.State} enum is defined such that if there is a state transition
  ...
  /**
   * A listener for the various state changes that a {@link com.google.common.util.concurrent.Service} goes through in its lifecycle.
   *
  ...
  abstract class Listener {
     ...
     * {@linkplain com.google.common.util.concurrent.Service.State#STARTING STARTING}. This occurs when {@link com.google.common.util.concurrent.Service#startAsync} is called
     * the first time.
     */
     ...
     * {@linkplain com.google.common.util.concurrent.Service.State#RUNNING RUNNING}.  This occurs when {@link com.google.common.util.concurrent.Service#stopAsync} is called.
     * 
