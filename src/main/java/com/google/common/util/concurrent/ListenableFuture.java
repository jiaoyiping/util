 ...
 * derived {@code Future}, as in {@link com.google.common.util.concurrent.Futures#allAsList(Iterable)
 ...
 * {@link com.google.common.util.concurrent.Futures#addCallback Futures.addCallback}.) Still, direct {@code
 ...
 * service to a {@link com.google.common.util.concurrent.ListeningExecutorService}, usually by calling {@link
 ...
 * convenient to use {@link com.google.common.util.concurrent.ListenableFutureTask} directly.)
 * <li>If they are manually filled in by a call to {@link java.util.concurrent.FutureTask#set} or a
 * similar method, create a {@link com.google.common.util.concurrent.SettableFuture} instead. (Users with more
 * complex needs may prefer {@link com.google.common.util.concurrent.AbstractFuture}.)
 * </ul>
 *
...
public interface ListenableFuture<V> extends Future<V> {
   ...
   * com.google.common.util.concurrent.MoreExecutors#directExecutor direct execution}) will be caught and
   * logged.
   *
   * <p>Note: For fast, lightweight listeners that would be safe to execute in
   * any thread, consider {@link com.google.common.util.concurrent.MoreExecutors#directExecutor}. For heavier
