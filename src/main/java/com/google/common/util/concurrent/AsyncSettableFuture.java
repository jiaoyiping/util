...
final class AsyncSettableFuture<V> extends ForwardingListenableFuture<V> {
   ...
   * com.google.common.util.concurrent.Futures#immediateFuture}.  Returns {@code true} if the future
  ...
  /**
   * Convenience method that calls {@link #setFuture} on a {@link
   * com.google.common.util.concurrent.Futures#immediateFailedFuture}.  Returns {@code true} if the
