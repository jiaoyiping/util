...
public final class ExecutionList {
   ...
   * {@link com.google.common.util.concurrent.ExecutionList.RunnableExecutorPair#next} field.
   */
  @GuardedBy("this")
  ...
  /** Creates a new, empty {@link com.google.common.util.concurrent.ExecutionList}. */
  ...
  /**
   * Submits the given runnable to the given {@link java.util.concurrent.Executor} catching and logging all
