...
/**
 * A {@code CheckedFuture} is a {@link com.google.common.util.concurrent.ListenableFuture} that includes versions
 ...
 *
 * <p>A common implementation is {@link com.google.common.util.concurrent.Futures#immediateCheckedFuture}.
 *
 ...
 * values with {@link com.google.common.util.concurrent.Futures#get(java.util.concurrent.Future, Class) Futures.get()}.
 *
 * @author Sven Mawson
 * @since 1.0
 */
