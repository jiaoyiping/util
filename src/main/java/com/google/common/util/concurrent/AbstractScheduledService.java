 ...
 * {@link com.google.common.util.concurrent.AbstractScheduledService.Scheduler}. When this service is asked to stop via {@link #stopAsync} it will cancel the
...
public abstract class AbstractScheduledService implements Service {
  ...
  /**
   * A scheduler defines the policy for how the {@link com.google.common.util.concurrent.AbstractScheduledService} should run its
   * task.
   * 
   * <p>Consider using the {@link #newFixedDelaySchedule} and {@link #newFixedRateSchedule} factory 
   * methods, these provide {@link com.google.common.util.concurrent.AbstractScheduledService.Scheduler} instances for the common use case of running the
   * service with a fixed schedule.  If more flexibility is needed then consider subclassing  
   * {@link com.google.common.util.concurrent.AbstractScheduledService.CustomScheduler}.
   * 
   * @author Luke Sandberg
   * @since 11.0
   */
  public abstract static class Scheduler {
    /**
     * Returns a {@link com.google.common.util.concurrent.AbstractScheduledService.Scheduler} that schedules the task using the
   ...
   * executor will not be {@linkplain java.util.concurrent.ScheduledExecutorService#shutdown shutdown} when this
   * service {@linkplain com.google.common.util.concurrent.Service.State#TERMINATED terminates} or
   * {@linkplain com.google.common.util.concurrent.Service.State#TERMINATED fails}. Subclasses may override this method to supply a
   * custom {@link java.util.concurrent.ScheduledExecutorService} instance. This method is guaranteed to only be called
   * once.
   * 
   ...
   * Also, the pool will be {@linkplain java.util.concurrent.ScheduledExecutorService#shutdown() shut down} when the
   * service {@linkplain com.google.common.util.concurrent.Service.State#TERMINATED terminates} or
   * {@linkplain com.google.common.util.concurrent.Service.State#TERMINATED fails}.
   */
  ...
  /**
   * Returns the name of this service. {@link com.google.common.util.concurrent.AbstractScheduledService} may include the name in
   * debugging output.
   *
   * @since 14.0
   */
  ...
  /**
   * A {@link com.google.common.util.concurrent.AbstractScheduledService.Scheduler} that provides a convenient way for the {@link com.google.common.util.concurrent.AbstractScheduledService} to
  ...
  public abstract static class CustomScheduler extends Scheduler {
    ...
    /**
     * A callable class that can reschedule itself using a {@link com.google.common.util.concurrent.AbstractScheduledService.CustomScheduler}.
     */
