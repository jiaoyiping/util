 ...
 * with {@link com.google.common.util.concurrent.Futures#withFallback}.
 *
...
public interface FutureFallback<V> {
   ...
   *     java.util.concurrent.Future#get() get} method throws an {@link java.util.concurrent.ExecutionException}, then the
