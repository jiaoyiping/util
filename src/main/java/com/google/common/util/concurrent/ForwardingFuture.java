 ...
 *
 * <p>Most subclasses can just use {@link com.google.common.util.concurrent.ForwardingFuture.SimpleForwardingFuture}.
 * 
 * @author Sven Mawson
 * @since 1.0
 */
public abstract class ForwardingFuture<V> extends ForwardingObject
   ...
   */
  /**
   * A simplified version of {@link com.google.common.util.concurrent.ForwardingFuture} where subclasses
