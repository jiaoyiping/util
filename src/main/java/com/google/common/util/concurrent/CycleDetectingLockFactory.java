...
/**
 * The {@code CycleDetectingLockFactory} creates {@link java.util.concurrent.locks.ReentrantLock} instances and
 * {@link java.util.concurrent.locks.ReentrantReadWriteLock} instances that detect potential deadlock by checking
 ...
 * execution of the {@link com.google.common.util.concurrent.CycleDetectingLockFactory.Policy} specified when creating the factory. The
 ...
 * <p>
 * The {@link com.google.common.util.concurrent.CycleDetectingLockFactory.WithExplicitOrdering} class can be used
...
public class CycleDetectingLockFactory {
   ...
   * encountered. Clients can use one of the predefined {@link com.google.common.util.concurrent.CycleDetectingLockFactory.Policies} or
   ...
   * calls to {@link #aboutToAcquire(com.google.common.util.concurrent.CycleDetectingLockFactory.CycleDetectingLock)} and
   * {@link #lockStateChanged(com.google.common.util.concurrent.CycleDetectingLockFactory.CycleDetectingLock)}.
   */
  ...
  private interface CycleDetectingLock {
    ...
    /** @return the {@link com.google.common.util.concurrent.CycleDetectingLockFactory.LockGraphNode} associated with this lock. */
  ...
  private static class LockGraphNode {
     ...
     *
     * @return If a path was found, a chained {@link com.google.common.util.concurrent.CycleDetectingLockFactory.ExampleStackTrace}
