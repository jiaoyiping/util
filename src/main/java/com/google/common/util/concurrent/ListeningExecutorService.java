...
/**
 * An {@link java.util.concurrent.ExecutorService} that returns {@link com.google.common.util.concurrent.ListenableFuture} instances. To create an instance
 * from an existing {@link java.util.concurrent.ExecutorService}, call
 * {@link com.google.common.util.concurrent.MoreExecutors#listeningDecorator(java.util.concurrent.ExecutorService)}.
 *
 * @author Chris Povirk
 * @since 10.0
 */
public interface ListeningExecutorService extends ExecutorService {
   ...
   * {@inheritDoc}
   *
   * <p>All elements in the returned list must be {@link com.google.common.util.concurrent.ListenableFuture} instances. The easiest
