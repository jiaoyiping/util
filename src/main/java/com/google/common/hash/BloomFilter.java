...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
   ...
   * passed in {@linkplain #create(com.google.common.hash.Funnel, int, double)}, or smaller. If it is
  ...
  /**
   * Creates a {@link com.google.common.hash.BloomFilter BloomFilter<T>} with the expected number of
   ...
   * serialization.
   *
   * <p>Use {@linkplain #readFrom(java.io.InputStream, com.google.common.hash.Funnel)} to reconstruct the written BloomFilter.
   */
  ...
  /**
   * Reads a byte stream, which was written by {@linkplain #writeTo(java.io.OutputStream)}, into
   ...
   *
   * @throws java.io.IOException if the InputStream throws an {@code IOException}, or if its data does
   *     not appear to be a BloomFilter serialized using the
   *     {@linkplain #writeTo(java.io.OutputStream)} method.
   */
