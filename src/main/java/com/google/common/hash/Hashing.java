...
/**
 * Static methods to obtain {@link com.google.common.hash.HashFunction} instances, and other static hashing-related
 * utilities.
 *
...
public final class Hashing {
   ...
   * for {@code minimumBits}, will return identically-behaving {@link com.google.common.hash.HashFunction} instances.
   *
   ...
   * to the {@link java.util.zip.CRC32} {@link java.util.zip.Checksum}.
   *
   * <p>To get the {@code long} value equivalent to {@link java.util.zip.Checksum#getValue()} for a
   * {@code HashCode} produced by this function, use {@link com.google.common.hash.HashCode#padToLong()}.
   *
   * @since 14.0
   */
   ...
   * delegating to the {@link java.util.zip.Adler32} {@link java.util.zip.Checksum}.
   *
   * <p>To get the {@code long} value equivalent to {@link java.util.zip.Checksum#getValue()} for a
   * {@code HashCode} produced by this function, use {@link com.google.common.hash.HashCode#padToLong()}.
   *
