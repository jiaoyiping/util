...
/**
 * Determines a true or false value for any Java {@code char} value, just as {@link com.google.common.base.Predicate} does
...
public abstract class CharMatcher implements Predicate<Character> {
   ...
   * method on {@link com.google.common.base.Platform} so that we can have different behavior in GWT.
   *
  ...
  /**
   * @deprecated Provided only to satisfy the {@link com.google.common.base.Predicate} interface; use {@link #matches}
   *     instead.
   */
  @Deprecated
  @Override
