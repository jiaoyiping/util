...
public final class Functions {
   ...
   * documented at {@link com.google.common.base.Function#apply}). For example, this function yields different results for
   ...
   * #forMap(java.util.Map, Object)}, which returns a default value in this case.
   *
   ...
   * set. See also {@link #forMap(java.util.Map)}, which throws an exception in this case.
   *
   ...
   * com.google.common.base.Function#apply}) if and only if {@code predicate} is itself consistent with equals.
   */
  public static <T> Function<T, Boolean> forPredicate(Predicate<T> predicate) {
    return new PredicateFunction<T>(predicate);
  }

  /** @see com.google.common.base.Functions#forPredicate */
  ...
  /**
   * Returns a function that always returns the result of invoking {@link com.google.common.base.Supplier#get} on {@code
  ...
  /** @see com.google.common.base.Functions#forSupplier*/
