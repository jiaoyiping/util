 ...
 * the values as signed are found in {@link com.google.common.primitives.SignedBytes}, and the methods for
 * which signedness is not an issue are in {@link com.google.common.primitives.Bytes}.
 *
