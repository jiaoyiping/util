 ...
 * {@code 2^32 + x}). The methods for which signedness is not an issue are in {@link com.google.common.primitives.Ints}, as well
 ...
 * {@code int} values. When possible, it is recommended that the {@link com.google.common.primitives.UnsignedInteger} wrapper
