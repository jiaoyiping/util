 ...
 * {@code 2^64 + x}). The methods for which signedness is not an issue are in {@link com.google.common.primitives.Longs}, as
 ...
 * {@code long} values. When possible, it is recommended that the {@link com.google.common.primitives.UnsignedLong} wrapper
