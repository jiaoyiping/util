 ...
 * {@link java.util.Iterator}-based method in the {@link com.google.common.collect.Iterators} class.
 *
...
public final class Iterables {
   ...
   * collection, and {@link com.google.common.collect.Iterators#removeAll} otherwise.
   *
   ...
   * collection, and {@link com.google.common.collect.Iterators#retainAll} otherwise.
   *
   * @param removeFrom the iterable to (potentially) remove elements from
   ...
   * <i>most</i> implementations of {@link java.util.Collection}, {@code
   ...
   * iterable is a {@link com.google.common.collect.Multiset} or {@link java.util.Set}.
   *
   ...
   * com.google.common.collect.Lists#partition(java.util.List, int)} instead.
   *
   ...
   * {@link #find(Iterable, com.google.common.base.Predicate, Object)} instead.
   *
  ...
  /**
   * Returns an {@link com.google.common.base.Optional} containing the first element in {@code
   ...
   * {@code Collection}, consider {@link com.google.common.collect.Lists#transform} and {@link
   ...
   * the iterable is empty.  The {@link com.google.common.collect.Iterators} analog to this method is
   * {@link com.google.common.collect.Iterators#getNext}.
   *
   * <p>If no default value is desired (and the caller instead wants a
   * {@link java.util.NoSuchElementException} to be thrown), it is recommended that
   ...
   * {@link java.util.Iterator} through {@link com.google.common.collect.Iterators#consumingIterator(java.util.Iterator)}.
   *
   ...
   *     through {@link com.google.common.collect.Iterators#consumingIterator(java.util.Iterator)}; for queues,
   *     an iterable that generates iterators that return and consume the
   *     queue's elements in queue order
   *
   * @see com.google.common.collect.Iterators#consumingIterator(java.util.Iterator)
   * @since 2.0
   */
