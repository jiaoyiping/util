 ...
 * the insertion ordering of values for a given key. See the {@link com.google.common.collect.Multimap}
...
public interface ListMultimap<K, V> extends Multimap<K, V> {
   ...
   * {@link java.util.List}. To obtain this map with the more specific generic type
   * {@code Map<K, List<V>>}, call {@link com.google.common.collect.Multimaps#asMap(com.google.common.collect.ListMultimap)}
   * instead.
   */
  @Override
