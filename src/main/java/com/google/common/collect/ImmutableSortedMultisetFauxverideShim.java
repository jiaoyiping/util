...
/**
 * "Overrides" the {@link com.google.common.collect.ImmutableMultiset} static methods that lack
 * {@link com.google.common.collect.ImmutableSortedMultiset} equivalents with deprecated, exception-throwing versions. This
 ...
 *
 * <p>While we could put the overrides in {@link com.google.common.collect.ImmutableSortedMultiset} itself, it seems clearer
...
abstract class ImmutableSortedMultisetFauxverideShim<E> extends ImmutableMultiset<E> {
  /**
   * Not supported. Use {@link com.google.common.collect.ImmutableSortedMultiset#naturalOrder}, which offers better
   * type-safety, instead. This method exists only to hide {@link com.google.common.collect.ImmutableMultiset#builder} from
   * consumers of {@code ImmutableSortedMultiset}.
   *
   * @throws UnsupportedOperationException always
   * @deprecated Use {@link com.google.common.collect.ImmutableSortedMultiset#naturalOrder}, which offers better type-safety.
   */
  @Deprecated
   ...
   *             {@link com.google.common.collect.ImmutableSortedMultiset#of(Comparable)}.</b>
   */
  @Deprecated
   ...
   *             {@link com.google.common.collect.ImmutableSortedMultiset#of(Comparable, Comparable)}.</b>
   */
  @Deprecated
   ...
   * @throws UnsupportedOperationException always
   * @deprecated <b>Pass the parameters of type {@code Comparable} to use
   *             {@link com.google.common.collect.ImmutableSortedMultiset#of(Comparable, Comparable, Comparable)}.</b>
   */
  @Deprecated
   ...
   *             com.google.common.collect.ImmutableSortedMultiset#of(Comparable, Comparable, Comparable, Comparable)}. </b>
   */
  @Deprecated
   ...
   * @throws UnsupportedOperationException always
   * @deprecated <b>Pass the parameters of type {@code Comparable} to use {@link
   *             com.google.common.collect.ImmutableSortedMultiset#of(Comparable, Comparable, Comparable, Comparable,
   *             Comparable)} . </b>
   */
  @Deprecated
   ...
   *             {@link com.google.common.collect.ImmutableSortedMultiset#copyOf(Comparable[])}.</b>
   */
  @Deprecated
