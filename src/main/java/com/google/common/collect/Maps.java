 ...
 * {@link java.util.SortedMap}, {@link com.google.common.collect.BiMap}, etc.). Also see this class's counterparts
 * {@link com.google.common.collect.Lists}, {@link com.google.common.collect.Sets} and {@link com.google.common.collect.Queues}.
 *
...
public final class Maps {
   ...
   * Internally, the returned map will be backed by an {@link java.util.EnumMap}.
   *
   ...
   * com.google.common.collect.ImmutableMap#of()} instead.
   *
   ...
   *
   * <p><b>Note:</b> if mutability is not required, use {@link
   * com.google.common.collect.ImmutableMap#copyOf(java.util.Map)} instead.
   *
   ...
   *
   * <p>This is currently accomplished by calling {@link com.google.common.collect.MapMaker#makeMap()}.
   *
   ...
   *
   * <p><b>Note:</b> if mutability is not required, use {@link
   * com.google.common.collect.ImmutableSortedMap#of()} instead.
   *
   ...
   *
   * <p><b>Note:</b> if mutability is not required, use {@link
   * com.google.common.collect.ImmutableSortedMap#copyOfSorted(java.util.SortedMap)} instead.
   *
  ...
  /**
   * Returns a live {@link java.util.Map} view whose keys are the contents of {@code set}
   * and whose values are computed on demand using {@code function}. To get an
   * immutable <i>copy</i> instead, use {@link #toMap(Iterable, com.google.common.base.Function)}.
   *
   ...
   * in {@code keys}.
   *
   * <p>If {@code keys} is a {@link java.util.Set}, a live view can be obtained instead of
   * a copy using {@link com.google.common.collect.Maps#asMap(java.util.Set, com.google.common.base.Function)}.
   *
  ...
  /** @see com.google.common.collect.Multimaps#unmodifiableEntries */
  ...
  /** @see com.google.common.collect.Maps#unmodifiableEntrySet(java.util.Set) */
  ...
  /**
   * Returns a {@link com.google.common.base.Converter} that converts values using {@link com.google.common.collect.BiMap#get bimap.get()},
   * and whose inverse view converts values using
   * {@link com.google.common.collect.BiMap#inverse bimap.inverse()}{@code .get()}.
   *
   * <p>To use a plain {@link java.util.Map} as a {@link com.google.common.base.Function}, see
   * {@link com.google.common.base.Functions#forMap(java.util.Map)} or
   * {@link com.google.common.base.Functions#forMap(java.util.Map, Object)}.
   *
   * @since 16.0
   */
  @Beta
  ...
  /** @see com.google.common.collect.Maps#unmodifiableBiMap(com.google.common.collect.BiMap) */
   ...
   * {@link com.google.common.collect.Maps#transformEntries(java.util.Map, com.google.common.collect.Maps.EntryTransformer)}.
   *
  ...
  public interface EntryTransformer<K, V1, V2> {
     ...
     *     {@link com.google.common.base.Objects#equal Objects.equal}{@code (k1, k2) &&}
     *     {@link com.google.common.base.Objects#equal}{@code (v1, v2)} implies that {@code
   ...
   * equals</i>, as documented at {@link com.google.common.base.Predicate#apply}. Do not provide a
   ...
   * documented at {@link com.google.common.base.Predicate#apply}.
   *
   * @since 14.0
   */
   ...
   * IllegalArgumentException}. Similarly, the map's entries have a {@link java.util.Map.Entry#setValue} method
   ...
   * equals</i>, as documented at {@link com.google.common.base.Predicate#apply}.
   */
   ...
   * {@link IllegalArgumentException}. Similarly, the map's entries have an {@link java.util.Map.Entry#setValue}
  ...
  /**
   * Delegates to {@link java.util.Map#remove}. Returns {@code null} on {@code
   * ClassCastException} and {@code NullPointerException}.
   */
