...
/**
 * An efficient immutable implementation of a {@link com.google.common.collect.RangeSet}.
 *
...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C>
  ...
  /**
   * Returns an immutable range set containing the single range {@link com.google.common.collect.Range#all()}.
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Returns an immutable range set containing the specified single range. If {@link com.google.common.collect.Range#isEmpty()
   * range.isEmpty()}, this is equivalent to {@link com.google.common.collect.ImmutableRangeSet#of()}.
   */
  ...
  /**
   * Returns an {@link com.google.common.collect.ImmutableSortedSet} containing the same values in the given domain
   * {@linkplain com.google.common.collect.RangeSet#contains contained} by this range set.
   *
   ...
   * such a set can be performed efficiently, but others (such as {@link java.util.Set#hashCode} or
   * {@link java.util.Collections#frequency}) can cause major performance problems.
   *
