 ...
 *
 * <p>In contrast to {@link com.google.common.collect.RangeSet}, no "coalescing" is done of {@linkplain
 * com.google.common.collect.Range#isConnected(com.google.common.collect.Range) connected} ranges, even if they are mapped to the same value.
 *
...
public interface RangeMap<K extends Comparable, V> {
  ...
  /**
   * Returns the minimal range {@linkplain com.google.common.collect.Range#encloses(com.google.common.collect.Range) enclosing} the ranges
   ...
   * {@link com.google.common.collect.Range#contains(Comparable) range.contains(k)}, then {@link #get(Comparable) get(k)}
   * will return {@code value}.
   *
   * <p>If {@code range} {@linkplain com.google.common.collect.Range#isEmpty() is empty}, then this is a no-op.
   */
   ...
   * insert a range not {@linkplain com.google.common.collect.Range#encloses(com.google.common.collect.Range) enclosed} by {@code range}.
   */
