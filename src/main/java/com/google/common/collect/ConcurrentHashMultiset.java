...
public final class ConcurrentHashMultiset<E> extends AbstractMultiset<E> implements Serializable {
   ...
   *
   * <p>This implementation is highly efficient when {@code elements} is itself a {@link com.google.common.collect.Multiset}.
   *
   ...
   *
   * <p>If this {@link com.google.common.collect.MapMaker} is configured to use entry eviction of any kind, this eviction
   ...
   * stored in the map, so {@link com.google.common.collect.MapMaker#expireAfterAccess} makes sense (evict the entry that
   * was queried or updated longest ago), but {@link com.google.common.collect.MapMaker#expireAfterWrite} doesn't, because
