...
/**
 * "Overrides" the {@link com.google.common.collect.ImmutableMap} static methods that lack
 * {@link com.google.common.collect.ImmutableSortedMap} equivalents with deprecated, exception-throwing
 * versions. See {@link com.google.common.collect.ImmutableSortedSetFauxverideShim} for details.
 *
 * @author Chris Povirk
 */
abstract class ImmutableSortedMapFauxverideShim<K, V>
  ...
  /**
   * Not supported. Use {@link com.google.common.collect.ImmutableSortedMap#naturalOrder}, which offers
   * better type-safety, instead. This method exists only to hide
   * {@link com.google.common.collect.ImmutableMap#builder} from consumers of {@code ImmutableSortedMap}.
   *
   * @throws UnsupportedOperationException always
   * @deprecated Use {@link com.google.common.collect.ImmutableSortedMap#naturalOrder}, which offers
   *     better type-safety.
   */
   ...
   *     com.google.common.collect.ImmutableSortedMap#of(Comparable, Object)}.</b>
   */
   ...
   *     com.google.common.collect.ImmutableSortedMap#of(Comparable, Object, Comparable, Object)}.</b>
   */
   ...
   * @throws UnsupportedOperationException always
   * @deprecated <b>Pass keys of type {@code Comparable} to use {@link
   *     com.google.common.collect.ImmutableSortedMap#of(Comparable, Object, Comparable, Object,
   *     Comparable, Object)}.</b>
   */
  @Deprecated public static <K, V> ImmutableSortedMap<K, V> of(
