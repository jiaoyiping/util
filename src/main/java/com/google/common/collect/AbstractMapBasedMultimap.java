...
/**
 * Basic implementation of the {@link com.google.common.collect.Multimap} interface. This class represents
 * a multimap as a map that associates each key with a collection of values. All
 * methods of {@link com.google.common.collect.Multimap} are supported, including those specified as
...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V>
   ...
   * behavior for most implementations. The {@link com.google.common.collect.LinkedHashMultimap} class
   * overrides it.
   *
   ...
   * com.google.common.collect.AbstractMapBasedMultimap#map} whenever the delegate is non-empty. The {@code
