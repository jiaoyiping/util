...
public final class Tables {
   ...
   * example, in a {@link com.google.common.collect.HashBasedTable} instance, {@code
   * rowKeySet().iterator()} supports {@code remove()} but {@code
   * columnKeySet().iterator()} doesn't. With a transposed {@link
   * com.google.common.collect.HashBasedTable}, it's the other way around.
   */
   ...
   * {@link com.google.common.collect.HashBasedTable} and {@link com.google.common.collect.TreeBasedTable} won't suffice.
   *
   * <p>The views returned by the {@code Table} methods {@link com.google.common.collect.Table#column},
   * {@link com.google.common.collect.Table#columnKeySet}, and {@link com.google.common.collect.Table#columnMap} have iterators that
   ...
   * applied many times for bulk operations like {@link com.google.common.collect.Table#containsValue} and
   ...
   *
   * <p>Consider using an {@link com.google.common.collect.ImmutableTable}, which is guaranteed never to change.
   * 
   * @param table
