 ...
 * com.google.common.collect.FluentIterable} is an enriched {@link Iterable}.
 *
 ...
 *     {@link java.util.Comparator} directly
 * <li>Pass a <i>pre-existing</i> {@link java.util.Comparator} instance to {@link
 *     #from(java.util.Comparator)}
 * <li>Use the natural ordering, {@link com.google.common.collect.Ordering#natural}
 * </ul>
 *
 ...
 * <ul>
 * <li>{@link #reverse}
 * <li>{@link #compound(java.util.Comparator)}
 * <li>{@link #onResultOf(com.google.common.base.Function)}
 * <li>{@link #nullsFirst} / {@link #nullsLast}
 * </ul>
 *
 * <p>Finally, use the resulting {@code Ordering} anywhere a {@link java.util.Comparator}
...
public abstract class Ordering<T> implements Comparator<T> {
   ...
   *
   * <p>Unlike {@link com.google.common.collect.Sets#newTreeSet(Iterable)}, this method does not discard
  ...
  /**
   * Exception thrown by a {@link com.google.common.collect.Ordering#explicit(java.util.List)} or {@link
   * com.google.common.collect.Ordering#explicit(Object, Object[])} comparator when comparing a value
