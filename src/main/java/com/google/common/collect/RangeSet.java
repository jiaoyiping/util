...
/**
 * A set comprising zero or more {@linkplain com.google.common.collect.Range#isEmpty nonempty},
 * {@linkplain com.google.common.collect.Range#isConnected(com.google.common.collect.Range) disconnected} ranges of type {@code C}.
 *
 * <p>Implementations that choose to support the {@link #add(com.google.common.collect.Range)} operation are required to
 ...
 *
 * <p>Note that the behavior of {@link com.google.common.collect.Range#isEmpty()} and {@link com.google.common.collect.Range#isConnected(com.google.common.collect.Range)} may
 * not be as expected on discrete ranges.  See the Javadoc of those methods for details.
 *
 * <p>For a {@link java.util.Set} whose contents are specified by a {@link com.google.common.collect.Range}, see {@link com.google.common.collect.ContiguousSet}.
 *
...
public interface RangeSet<C extends Comparable> {
  ...
  /**
   * Returns the unique range from this range set that {@linkplain com.google.common.collect.Range#contains contains}
   ...
   * {@linkplain com.google.common.collect.Range#encloses encloses} the specified range.
   */
   ...
   * this range set which {@linkplain com.google.common.collect.Range#encloses encloses} it. It follows that
  ...
  /**
   * Returns the minimal range which {@linkplain com.google.common.collect.Range#encloses(com.google.common.collect.Range) encloses} all ranges
   * in this range set.
   *
   * @throws java.util.NoSuchElementException if this range set is {@linkplain #isEmpty() empty}
   */
  Range<C> span();
  ...
  /**
   * Returns a view of the {@linkplain com.google.common.collect.Range#isConnected disconnected} ranges that make up this
   ...
   * {@linkplain #add(com.google.common.collect.Range) add} any range not {@linkplain com.google.common.collect.Range#encloses(com.google.common.collect.Range) enclosed} by
   * {@code view}.
   */
   ...
   *
   * <p>Note that {@code range} will be {@linkplain com.google.common.collect.Range#span(com.google.common.collect.Range) coalesced} with any ranges in
   * the range set that are {@linkplain com.google.common.collect.Range#isConnected(com.google.common.collect.Range) connected} with it.  Moreover,
   ...
   * {@linkplain #enclosesAll(com.google.common.collect.RangeSet) encloses} both the original range set and {@code other}.
   *
   ...
   * according to {@link com.google.common.collect.Range#equals(Object)}.
   */
  @Override
