...
/**
 * A {@link com.google.common.collect.Multiset} which maintains the ordering of its elements, according to
 * either their natural order or an explicit {@link java.util.Comparator}. This order is
...
public interface SortedMultiset<E> extends SortedMultisetBridge<E>, SortedIterable<E> {
   ...
   * {@link com.google.common.collect.Ordering#natural()} if the natural ordering of the elements is used.
   */
  ...
  /**
   * Returns a {@link java.util.NavigableSet} view of the distinct elements in this multiset.
   * 
