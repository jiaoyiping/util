 ...
 * {@link Iterable}-based method in the {@link com.google.common.collect.Iterables} class.
 *
...
public final class Iterators {
   ...
   *     Java 7 or later, {@link java.util.Collections#emptyIterator}. This method is
   ...
   * #find(java.util.Iterator, com.google.common.base.Predicate, Object)} instead.
   *
   ...
   * no such element is found, an empty {@link com.google.common.base.Optional} will be returned from
   ...
   * the iterator is empty.  The {@link com.google.common.collect.Iterables} analog to this method is
   * {@link com.google.common.collect.Iterables#getFirst}.
   *
   * @param defaultValue the default value to return if the iterator is empty
   ...
   * java.util.Arrays#asList(Object[])}, {@link com.google.common.collect.ImmutableList#copyOf(Object[])}},
   * or {@link com.google.common.collect.ImmutableList#of}.
   */
   ...
   *
   * <p>This method has no equivalent in {@link com.google.common.collect.Iterables} because viewing an
   ...
   * performed by the iterator's own {@link com.google.common.collect.PeekingIterator#remove()} method)
   * will leave the iterator in an undefined state.
   *
   * <p>The returned iterator does not support removal after peeking, as
   * explained by {@link com.google.common.collect.PeekingIterator#remove()}.
   *
   ...
   *
   * @param iterator the backing iterator. The {@link com.google.common.collect.PeekingIterator} assumes
   ...
   *     additional {@link com.google.common.collect.PeekingIterator#peek()} method, this iterator behaves
