 ...
 * class's counterparts {@link com.google.common.collect.Sets}, {@link com.google.common.collect.Maps} and {@link com.google.common.collect.Queues}.
 *
...
public final class Lists {
   ...
   * {@linkplain java.util.ArrayList#ArrayList() constructor} directly, taking advantage
   ...
   * might be null, or you need support for {@link java.util.List#set(int, Object)}, use
   ...
   * calling {@link java.util.Collections#addAll}. This method is not actually very useful
   ...
   * {@link com.google.common.collect.Iterables#addAll}.
   *
   * <p><b>Note:</b> if mutability is not required and the elements are
   * non-null, use {@link com.google.common.collect.ImmutableList#copyOf(Iterable)} instead. (Or, change
   * {@code elements} to be a {@link com.google.common.collect.FluentIterable} and call
   * {@code elements.toList()}.)
   *
   * <p><b>Note for Java 7 and later:</b> if {@code elements} is a {@link
   * java.util.Collection}, you don't need this method. Use the {@code ArrayList}
   * {@linkplain java.util.ArrayList#ArrayList(java.util.Collection) constructor} directly, taking
   ...
   * {@link com.google.common.collect.Iterators#addAll}.
   *
   * <p><b>Note:</b> if mutability is not required and the elements are
   * non-null, use {@link com.google.common.collect.ImmutableList#copyOf(java.util.Iterator)} instead.
   */
  @GwtCompatible(serializable = true)
   ...
   * initial size; simply delegates to {@link java.util.ArrayList#ArrayList(int)}.
   *
   * <p><b>Note for Java 7 and later:</b> this method is now unnecessary and
   * should be treated as deprecated. Instead, use {@code new }{@link
   * java.util.ArrayList#ArrayList(int) ArrayList}{@code <>(int)} directly, taking
   * advantage of the new <a href="http://goo.gl/iz2Wi">"diamond" syntax</a>.
   ...
   * com.google.common.collect.ImmutableList#of()} instead.
   *
   * <p><b>Performance note:</b> {@link java.util.ArrayList} and {@link
   ...
   * {@linkplain java.util.LinkedList#LinkedList() constructor} directly, taking advantage
   * of the new <a href="http://goo.gl/iz2Wi">"diamond" syntax</a>.
   */
  @GwtCompatible(serializable = true)
   ...
   *
   * <p><b>Note for Java 7 and later:</b> if {@code elements} is a {@link
   * java.util.Collection}, you don't need this method. Use the {@code LinkedList}
   * {@linkplain java.util.LinkedList#LinkedList(java.util.Collection) constructor} directly, taking
   * advantage of the new <a href="http://goo.gl/iz2Wi">"diamond" syntax</a>.
   */
  @GwtCompatible(serializable = true)
  public static <E> LinkedList<E> newLinkedList(
  ...
  /** @see com.google.common.collect.Lists#asList(Object, Object, Object[]) */
   ...
   * {@link com.google.common.collect.Collections2#transform} or {@link com.google.common.collect.Iterables#transform}.
   *
   ...
   * copy the list using {@link com.google.common.collect.ImmutableList#copyOf(java.util.Collection)} (for example),
   ...
   *
   * @see com.google.common.collect.Lists#transform
   */
