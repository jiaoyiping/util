...
public class TreeMultimap<K, V> extends AbstractSortedKeySortedSetMultimap<K, V> {
   ...
   * Neither comparator may be null; use {@link com.google.common.collect.Ordering#natural()} to specify
   * natural order.
   *
   ...
   * returns a {@link java.util.NavigableSet}, instead of the {@link java.util.Set} specified
   ...
   *
   * <p>Because a {@code TreeMultimap} has unique sorted keys, this method
   * returns a {@link java.util.NavigableMap}, instead of the {@link java.util.Map} specified
   * in the {@link com.google.common.collect.Multimap} interface.
   * 
