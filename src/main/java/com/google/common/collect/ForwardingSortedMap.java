...
public abstract class ForwardingSortedMap<K, V> extends ForwardingMap<K, V>
  ...
  /**
   * A sensible implementation of {@link java.util.SortedMap#keySet} in terms of the methods of
   * {@code ForwardingSortedMap}. In many cases, you may wish to override
   * {@link com.google.common.collect.ForwardingSortedMap#keySet} to forward to this implementation or a subclass thereof.
   *
   * @since 15.0
   */
  @Beta
