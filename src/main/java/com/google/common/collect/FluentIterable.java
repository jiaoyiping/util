 ...
 * (often with {@link com.google.common.collect.Iterables}), however the use of {@code FluentIterable} makes many sets of
...
public abstract class FluentIterable<E> implements Iterable<E> {
  ...
  /**
   * Returns an {@link com.google.common.base.Optional} containing the first element in this fluent iterable.
   ...
   *     {@code iterator().next()} or {@link com.google.common.collect.Iterables#getFirst} instead.
   */
  ...
  /**
   * Returns an {@link com.google.common.base.Optional} containing the last element in this fluent iterable.
   * If the iterable is empty, {@code Optional.absent()} is returned.
   *
   * @throws NullPointerException if the last element is null; if this is a possibility, use
   *     {@link com.google.common.collect.Iterables#getLast} instead.
   */
