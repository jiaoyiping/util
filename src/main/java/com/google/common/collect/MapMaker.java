 ...
 * map that behaves similarly to a {@link java.util.concurrent.ConcurrentHashMap}.
 *
 ...
 * occasional map accesses; such entries may be counted by {@link java.util.Map#size}, but will never be
 ...
 * {@linkplain java.util.Map#entrySet entry set} is a snapshot of that entry's state at the time of
...
public final class MapMaker extends GenericMapMaker<Object, Object> {
   ...
   *
   * <p>By default, the map uses {@link com.google.common.base.Equivalence#identity} to determine key equality when {@link
   * #weakKeys} is specified, and {@link com.google.common.base.Equivalence#equals()} otherwise. The only place this is
   * used is in {@link com.google.common.collect.Interners.WeakInterner}.
   */
   ...
   * after removing an element for any reason (see removal causes in {@link com.google.common.collect.MapMaker.RemovalCause}). It will
   ...
   *     result
   * <li>{@link com.google.common.collect.ComputationException} if an exception was thrown by the computing function. If that
   * exception is already of type {@link com.google.common.collect.ComputationException} it is propagated directly; otherwise
   * it is wrapped.
   * </ul>
   *
  ...
  static final class RemovalNotification<K, V> extends ImmutableEntry<K, V> {
     ...
     * {@link com.google.common.collect.MapMaker.RemovalCause#EXPLICIT} nor {@link com.google.common.collect.MapMaker.RemovalCause#REPLACED}).
     */
