...
/**
 * A class exactly like {@link com.google.common.collect.MapMaker}, except restricted in the types of maps it can build.
...
abstract class GenericMapMaker<K0, V0> {
  ...
  /**
   * See {@link com.google.common.collect.MapMaker#keyEquivalence}.
   */
  @GwtIncompatible("To be supported")
  abstract GenericMapMaker<K0, V0> keyEquivalence(Equivalence<Object> equivalence);

  /**
   * See {@link com.google.common.collect.MapMaker#initialCapacity}.
   */
  public abstract GenericMapMaker<K0, V0> initialCapacity(int initialCapacity);

  /**
   * See {@link com.google.common.collect.MapMaker#maximumSize}.
   */
  abstract GenericMapMaker<K0, V0> maximumSize(int maximumSize);

  /**
   * See {@link com.google.common.collect.MapMaker#concurrencyLevel}.
   */
  public abstract GenericMapMaker<K0, V0> concurrencyLevel(int concurrencyLevel);

  /**
   * See {@link com.google.common.collect.MapMaker#weakKeys}.
   */
  @GwtIncompatible("java.lang.ref.WeakReference")
  public abstract GenericMapMaker<K0, V0> weakKeys();

  /**
   * See {@link com.google.common.collect.MapMaker#weakValues}.
   */
  @GwtIncompatible("java.lang.ref.WeakReference")
  public abstract GenericMapMaker<K0, V0> weakValues();

  /**
   * See {@link com.google.common.collect.MapMaker#softValues}.
   *
  ...
  /**
   * See {@link com.google.common.collect.MapMaker#expireAfterWrite}.
   */
  abstract GenericMapMaker<K0, V0> expireAfterWrite(long duration, TimeUnit unit);

  /**
   * See {@link com.google.common.collect.MapMaker#expireAfterAccess}.
   */
  @GwtIncompatible("To be supported")
  ...
  /**
   * See {@link com.google.common.collect.MapMaker#makeMap}.
   */
  public abstract <K extends K0, V extends V0> ConcurrentMap<K, V> makeMap();

  /**
   * See {@link com.google.common.collect.MapMaker#makeCustomMap}.
   */
  @GwtIncompatible("MapMakerInternalMap")
  abstract <K, V> MapMakerInternalMap<K, V> makeCustomMap();

  /**
   * See {@link com.google.common.collect.MapMaker#makeComputingMap}.
   */
  @Deprecated
