...
/**
 * A variant of {@link com.google.common.collect.TreeTraverser} for binary trees, providing additional traversals specific to
 * binary trees.
 *
...
public abstract class BinaryTreeTraverser<T> extends TreeTraverser<T> {
  ...
  /**
   * Returns the left child of the specified node, or {@link com.google.common.base.Optional#absent()} if the specified
   * node has no left child.
   */
  public abstract Optional<T> leftChild(T root);

  /**
   * Returns the right child of the specified node, or {@link com.google.common.base.Optional#absent()} if the specified
