 ...
 * an appropriate {@link com.google.common.collect.DiscreteDomain} to {@link com.google.common.collect.ContiguousSet#create}.
 *
 ...
 * <tr><td>{@code (a..b)}  <td>{@code {x | a < x < b}}  <td>{@link com.google.common.collect.Range#open open}
 * <tr><td>{@code [a..b]}  <td>{@code {x | a <= x <= b}}<td>{@link com.google.common.collect.Range#closed closed}
 * <tr><td>{@code (a..b]}  <td>{@code {x | a < x <= b}} <td>{@link Range#openClosed openClosed}
 * <tr><td>{@code [a..b)}  <td>{@code {x | a <= x < b}} <td>{@link com.google.common.collect.Range#closedOpen closedOpen}
 * <tr><td>{@code (a..+∞)} <td>{@code {x | x > a}}      <td>{@link com.google.common.collect.Range#greaterThan greaterThan}
 * <tr><td>{@code [a..+∞)} <td>{@code {x | x >= a}}     <td>{@link com.google.common.collect.Range#atLeast atLeast}
 * <tr><td>{@code (-∞..b)} <td>{@code {x | x < b}}      <td>{@link com.google.common.collect.Range#lessThan lessThan}
 * <tr><td>{@code (-∞..b]} <td>{@code {x | x <= b}}     <td>{@link Range#atMost atMost}
 * <tr><td>{@code (-∞..+∞)}<td>{@code {x}}              <td>{@link com.google.common.collect.Range#all all}
 * </table></blockquote>
 *
 ...
 *     100."
 * <li>When evaluated as a {@link com.google.common.base.Predicate}, a range yields the same result as invoking {@link
 *     #contains}.
...
public final class Range<C extends Comparable> implements Predicate<C>, Serializable {
  ...
  /**
   * Returns a range that {@linkplain com.google.common.collect.Range#contains(Comparable) contains} only
   * the given value. The returned range is {@linkplain com.google.common.collect.BoundType#CLOSED closed}
   * on both ends.
   *
   * @since 14.0
   */
   ...
   * {@linkplain com.google.common.collect.Range#contains(Comparable) contains} all of the given values.
   * The returned range is {@linkplain com.google.common.collect.BoundType#CLOSED closed} on both ends.
   *
  ...
  /**
   * Returns the type of this range's lower bound: {@link com.google.common.collect.BoundType#CLOSED} if the range includes
   * its lower endpoint, {@link com.google.common.collect.BoundType#OPEN} if it does not.
   *
   * @throws IllegalStateException if this range is unbounded below (that is, {@link
   *     #hasLowerBound()} returns {@code false})
   */
  ...
  /**
   * Returns the type of this range's upper bound: {@link com.google.common.collect.BoundType#CLOSED} if the range includes
   * its upper endpoint, {@link com.google.common.collect.BoundType#OPEN} if it does not.
   *
   * @throws IllegalStateException if this range is unbounded above (that is, {@link
   *     #hasUpperBound()} returns {@code false})
   */
   ...
   * helpful to preprocess ranges with {@link #canonical(com.google.common.collect.DiscreteDomain)}.
   */
  ...
  /**
   * @deprecated Provided only to satisfy the {@link com.google.common.base.Predicate} interface; use {@link #contains}
   *     instead.
   */
  @Deprecated
  @Override
   ...
   * <i>partial order</i> over ranges. There exists a unique {@linkplain com.google.common.collect.Range#all maximal} range
   ...
   * com.google.common.base.Equivalence equivalence relation} as it is not transitive.
   *
   ...
   * {@link #canonical(com.google.common.collect.DiscreteDomain)} before testing for connectedness.
   */
   ...
   * element is {@link com.google.common.collect.Range#all}).
   *
   ...
   *
   * <p>Like {@link #intersection(com.google.common.collect.Range) intersection}, this operation is commutative, associative
