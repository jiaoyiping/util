...
@Beta final class SortedLists {
   ...
   * algorithm.
   *
   * <p>Equivalent to {@link #binarySearch(java.util.List, com.google.common.base.Function, Object, java.util.Comparator, com.google.common.collect.SortedLists.KeyPresentBehavior,
   * com.google.common.collect.SortedLists.KeyAbsentBehavior)} using {@link com.google.common.collect.Ordering#natural}.
   */
   ...
   *
   * <p>Equivalent to
   * {@link #binarySearch(java.util.List, Object, java.util.Comparator, com.google.common.collect.SortedLists.KeyPresentBehavior, com.google.common.collect.SortedLists.KeyAbsentBehavior)} using
   * {@link com.google.common.collect.Lists#transform(java.util.List, com.google.common.base.Function) Lists.transform(list, keyFunction)}.
   */
   ...
   * {@link com.google.common.collect.SortedLists.KeyPresentBehavior} decides which index is returned. If no elements compare as equal to
   * the key, the choice of {@link com.google.common.collect.SortedLists.KeyAbsentBehavior} decides which index is returned.
   *
