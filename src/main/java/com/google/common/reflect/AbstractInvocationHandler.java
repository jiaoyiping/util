...
public abstract class AbstractInvocationHandler implements InvocationHandler {
   ...
   *
   * <p><ul>
   * <li>{@code proxy.hashCode()} delegates to {@link com.google.common.reflect.AbstractInvocationHandler#hashCode}
   * <li>{@code proxy.toString()} delegates to {@link com.google.common.reflect.AbstractInvocationHandler#toString}
   * <li>{@code proxy.equals(argument)} returns true if: <ul>
   *   <li>{@code proxy} and {@code argument} are of the same type
   *   <li>and {@link com.google.common.reflect.AbstractInvocationHandler#equals} returns true for the {@link
   *       java.lang.reflect.InvocationHandler} of {@code argument}
   *   </ul>
   ...
   * <li>{@code proxy} and {@code argument} are of the same type
   * <li>and this method returns true for the {@link java.lang.reflect.InvocationHandler} of {@code argument}
   * </ul>
